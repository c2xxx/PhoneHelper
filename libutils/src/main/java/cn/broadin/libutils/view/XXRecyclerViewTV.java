...
public class XXRecyclerViewTV extends RecyclerView {

    public XXRecyclerViewTV(Context context) {
        super(context);
        init(context);
    }

    public XXRecyclerViewTV(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public XXRecyclerViewTV(Context context, AttributeSet attrs, int defStyle) {
